...
class RedBlackBSTSet<Key extends Comparable<Key>> {
	...
	public static void main(String[] args) {
		...
		RedBlackBSTSet<String> st = new RedBlackBSTSet<String>();
		String[] entries = { "this", "is", "a", "good", "day", "to", "program",
				"in", "java" };
		...
		for (i = 0; i < entries.length; i++) {
			System.out.println("Rank of " + "\'" + entries[i] + "\': "
					+ st.rank(entries[i]));
		}
...
public class QuadrantQueries {
	...
	// public RedBlackBSTSet<Integer> q1 = new RedBlackBSTSet<Integer>();
	// public RedBlackBSTSet<Integer> q2 = new RedBlackBSTSet<Integer>();
	// public RedBlackBSTSet<Integer> q3 = new RedBlackBSTSet<Integer>();
	// public RedBlackBSTSet<Integer> q4 = new RedBlackBSTSet<Integer>();

	@SuppressWarnings("unchecked")
	public static RedBlackBSTSet<Integer>[] quads = (RedBlackBSTSet<Integer>[]) new RedBlackBSTSet<?>[4];
	static {
		for (int i = 0; i < 4; i++) {
			quads[i] = new RedBlackBSTSet<Integer>();
		}
	}
